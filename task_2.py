...
'''
Немного изменил основной алгоритм. Убрал ручное добавление элементов, заменив на автоматическое с проверкой. 
Также изменил подход к взятью левого\правого потомка - нужна указать родителя. Добавил проверки на наличия узла в дереве.
Нашел алгоритм для вывода графа в консоль. Получилась вот такая красота:
...
Довольно долго разбирался, но в конце концов понял, что да как тут работает.
'''
